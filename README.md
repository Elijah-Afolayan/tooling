...
I am updating this file to verify is the Post-build Action(send build artifacts over SSH) is upd and running if i can see this update in the Readme file on the NSF-server so lets see how it goses lololololo
